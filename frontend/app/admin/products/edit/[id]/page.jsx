...
export default function EditProductPage({ params }) {
  ...
  const [formData, setFormData] = useState({
    name: "Durum Wheat Semolina (Suji)",
    category: "Grains & Cereals",
    origin: "Gujarat / Madhya Pradesh",
    image: "/categories_img/Wheat.jpg",
    specs: "Protein > 12% • Moisture < 12%",
    status: "Active",
    description: "Eco Export supplies premium Durum Wheat Semolina processed under strict APEDA standards for pasta, bakery, and overseas wholesale markets.",
  });

  const [isDragging, setIsDragging] = useState(false);
  const [previewUrl, setPreviewUrl] = useState("/categories_img/Wheat.jpg");
  ...
  return (
    <AdminFormLayout
      ...
      subtitle="Modify product specifications, origin, category, and main showcase image."
