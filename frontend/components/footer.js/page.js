      ...
      <div className={styles.container}>
        ...
        <div className={styles.brandCol}>
          ...
          <div className={styles.mobileQuickActions}>
            ...
            <a href="https://wa.me/919265000000" target="_blank" rel="noopener noreferrer" className={`${styles.mobileActionBtn} ${styles.whatsappBtn}`}>
          ...
          <div className={styles.social}>
            ...
            <a href="https://wa.me/919265000000" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" className={styles.socialIcon}>
