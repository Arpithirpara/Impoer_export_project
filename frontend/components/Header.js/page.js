          ...
          <div className={styles.mobileOverlayBody}>
            ...
            <div className={styles.mobileContactSection}>
              ...
              <div className={styles.mobileSocialRow}>
                <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className={styles.mobileSocialChip}>
                ...
                <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className={styles.mobileSocialChip}>
                ...
                <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className={styles.mobileSocialChip}>
                ...
                <a href="https://wa.me/919265000000" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" className={styles.mobileSocialChip}>
