...
const whyChoosePoints = [
  {
    ...
    description:
      "Every shipment of tea, coffee, rice, spices, and grains undergoes multi-tier quality testing, lab grading, and international standard certification before export.",
    icon: (
      <svg
        width="26"
        height="26"
  ...
  },
  {
    ...
    description:
      "Complete hassle-free documentation — APEDA registration, Phytosanitary Certificates, FSSAI compliance, certificate of origin, and custom export clearance.",
    icon: (
      <svg
        width="26"
        height="26"
  ...
  },
  {
    ...
    description:
      "We source directly from over 5,000+ verified agricultural cooperatives across India, eliminating middlemen to deliver fresh produce at direct wholesale rates.",
    icon: (
      <svg
        width="26"
        height="26"
  ...
  },
  {
    ...
    description:
      "State-of-the-art vacuum sealing, moisture-proof multi-ply bags, custom private labeling, and climate-controlled container packaging tailored for long ocean voyages.",
    icon: (
      <svg
        width="26"
        height="26"
  ...
  },
  {
    ...
    description:
      "13+ years of specialized experience in international maritime sea freight, port handling, swift customs clearance, and seamless tracking to 50+ countries.",
    icon: (
      <svg
        width="26"
        height="26"
  ...
  },
  {
    ...
    description:
      "Dedicated account managers offering transparent wholesale pricing, flexible export payment terms (LC/TT), 24-hour quotation responses, and total buyer satisfaction.",
    icon: (
      <svg
        width="26"
        height="26"
...
const certifications = [
  ...
  },
  {
    ...
    description:
      "Authorized exporter of premium Indian spices, powders, whole seeds, and essential oleoresins.",
    logo: "/home_page_cartificateslogo/Spices_board.png",
  },
  {
    code: "IOPEPC",
    ...
    description:
      "Recognized merchant exporter for oilseeds, sesame, peanuts, and specialty agricultural produce.",
    logo: "/home_page_cartificateslogo/iopepc.png",
  },
  {
    code: "DGFT / FIEO",
    ...
    description:
      "Official IEC licensed global trader with full custom documentation and port clearance privileges.",
    logo: "/home_page_cartificateslogo/DGFT.png",
  },
];
      ...
      <section className={styles.homeSection}>
        <div className={styles.hero}>
          <div className={styles.heroText}>
            ...
            <p>
              We deliver premium tea, coffee, rice, spices and grains from farm
              to market with trusted logistics, complete export documentation,
            ...
            <div className={styles.heroHighlights}>
              {heroHighlights.map((item) => (
                <div key={item.label} className={styles.heroHighlightCard}>
                  <div className={styles.highlightIconWrapper}>{item.icon}</div>
      ...
      <section className={styles.whySection}>
        <div className={styles.whyContainer}>
          <div className={styles.whyHeader}>
            ...
            <p>
              Combining farm-fresh sourcing, rigorous quality compliance,
              advanced packaging infrastructure, and worldwide freight expertise
              to deliver excellence at every port.
            </p>
          </div>
            ...
            {whyChoosePoints.map((item, index) => (
              <div key={index} className={styles.whyCard}>
                ...
                <div className={styles.whyCardFooter}>
                  <span className={styles.whyCheckText}>
      ...
      <section className={styles.mapSection}>
        <div className={styles.mapContainer}>
          <div className={styles.mapHeader}>
            ...
            <h2>
              Exporting To{" "}
              <span className={styles.mapHighlight}>50+ Countries</span>
            </h2>
            <p>
      ...
      <section className={styles.certSection}>
        <div className={styles.certContainer}>
          <div className={styles.certHeader}>
            ...
            <h2>
              Recognized &{" "}
              <span className={styles.certHighlight}>Certified Exporter</span>
            </h2>
            <p>
              Holding full accreditation, export licenses, and international
              quality certifications from leading Indian & global trade
              authorities.
            </p>
          </div>

          {/* 6 Circular Off-Green Certificate Logo Badges (One-by-One Smooth Slider) */}
          <div className={styles.certSliderViewport}>
            <div className={styles.certSliderTrack}>
              {[...certifications, ...certifications].map((cert, index) => (
                <div
                  key={index}
                  className={styles.certCircleCard}
                  title={cert.name}
                >
                  <img
                    src={cert.logo}
                    alt={`${cert.code} Logo`}
                    className={styles.certCircleImg}
                  />
                </div>
              ))}
            </div>
