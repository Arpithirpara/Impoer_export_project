...
export default function AddCategoryPage() {
  ...
  return (
    <AdminFormLayout
      title="Add New Category Line"
      subtitle="Create a new commodity category classification and upload showcase image."
    ...
    >
      <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
        ...
        <div>
          ...
          <textarea
            rows={3}
            placeholder="Brief overview of commodities listed under this category line..."
