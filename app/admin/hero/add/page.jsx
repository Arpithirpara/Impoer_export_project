...
import { UploadCloud, Image as ImageIcon, Check, RefreshCw, X } from "lucide-react";
...
export default function AddHeroBannerPage() {
  ...
  return (
    <AdminFormLayout
      ...
      subtitle="Configure homepage slider banner image, main headline title, and subtitle text."
      backUrl="/admin/hero"
      isEdit={false}
    >
      <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
        ...
        <div>
          ...
          <input
            type="text"
            required
            placeholder="e.g. Premium Agricultural Export & Import Solutions"
        ...
        <div>
          ...
          <input
            type="text"
            placeholder="e.g. Delivering 100% certified Indian agro commodities across 30+ countries."
